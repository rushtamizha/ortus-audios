...
export const metadata = {
  title: "Ortus Audios | Premium Home Theatre & AV Solutions Bangalore",
  description: "Experience world-class cinematic sound with Ortus Audios. Authorized dealers for ELAC, BenQ, and Epson in Kammanahalli, Bangalore , Karnataka. Bespoke acoustic design and installation.",
  keywords: ["Home Theatre Bangalore", "ELAC Speakers India", "Audio Video Solutions Kammanahalli", "Projector Installation Bangalore", "Hi-Fi Audio Store"],
  ...
  openGraph: {
    ...
    description: "Bespoke Home Cinema & Premium Audio Systems in Bangalore.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Ortus Audios Showroom Bangalore',
      },
    ],
    locale: 'en_IN',
    type: 'website',
