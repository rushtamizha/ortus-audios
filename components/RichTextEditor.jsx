...
const MasterEditor = ({ content, onChange }) => {
  ...
  return (
    <div className="w-full bg-[#050508] border border-white/10 rounded-3xl overflow-hidden shadow-2xl">
      <style>{`
        /* FIX: Ensure the editor doesn't expand past its parent container */
        .ql-container { 
          font-size: 18px; 
          min-height: 500px; 
        ...
        /* FIX: Make text visible on dark background */
        .ql-editor {
          color: rgba(255, 255, 255, 0.8) !important;
          line-height: 1.8;
          padding: 2rem !important;
          word-break: break-word; /* Prevents text from pushing width */
        }
        ...
        /* FIX: Style the toolbar for Dark Mode */
        .ql-toolbar {
