...
import "react-quill-new/dist/quill.snow.css"; // Simple, clean theme

const MasterEditor = ({ content, onChange }) => {
  ...
  // Define Toolbar options (All your Tiptap features)
  ...
  return (
    <div className="w-full bg-white text-black rounded-xl overflow-hidden border border-gray-200">
      <style>{`
        ...
        .ql-toolbar { border-top: none !important; border-left: none !important; border-right: none !important; background: #f9f9f9; }
      `}</style>
      <ReactQuill
        ref={quillRef}
        theme="snow"
